...
const en: HandoffStrings = {
  ...
  explore: {
    ...
    resultsCountZero: "No services found",
  },
  categories: {
    all: "All",
    nails: "Nails",
...
const hr: HandoffStrings = {
  ...
  explore: {
    ...
    resultsCount: "{count} usluga pronadeno",
    resultsCountZero: "Nema pronadenih usluga",
  },
  categories: {
    all: "Sve",
    nails: "Nokti",
...
const es: HandoffStrings = {
  ...
  explore: {
    ...
    resultsCountZero: "No se encontraron servicios",
  },
  categories: {
    all: "Todo",
    nails: "Unas",
