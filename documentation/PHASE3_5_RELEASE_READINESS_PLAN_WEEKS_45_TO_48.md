# Phase 3.5 — Release Readiness (Weeks 47–51)

> **Filename note:** the document filename retains `WEEKS_45_TO_48` for stable links across the program. The phase is **5 weeks** (W47–W51). A new W50 (support skeleton, no AI) was inserted so that customer-facing in-app support and the platform-owner support dashboard are live at commercial GA. Compliance/BI/GA moved from W50 to W51.
...
## Entry Conditions (must be true before Week 47 starts)
...
### Week 47 — Observability, SLOs, Performance Gates
...
### Week 48 — Pentest, Disaster Recovery, Security Hardening
...
### Week 49 — AI Quality Evaluation, Marketing Site, Self-Serve Signup
...
- **SOC 2 Type 1 vendor selection** (per [US_PRIMARY_MARKET_ADDENDUM.md](US_PRIMARY_MARKET_ADDENDUM.md)): pick auditor and scope; kickoff scheduled for Phase 5 (W55+).

### Week 50 — Support Skeleton at Launch (no AI yet)
...
### Week 51 — Compliance Pack, BI Export, Launch Polish, GA
...
## Parallel Streams (run alongside Weeks 47–51)
...
- **Customer success**: support tooling tenant configured, runbook authored, first-line training material; runbook content seeds the W50 KB authoring UI.
...
- Phase 3 plan: [PHASE3_ADMIN_UI_PLAN_WEEKS_33_TO_44.md](PHASE3_ADMIN_UI_PLAN_WEEKS_33_TO_44.md) *(filename retains WEEKS_33_TO_44; actual weeks: 35–46)*
